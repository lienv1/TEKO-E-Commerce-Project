...
docker run -d --name mysql-container -e MYSQL_ROOT_PASSWORD=my-secret-pw -v "$(pwd)/mysql-data:/var/lib/mysql" -e MYSQL_DATABASE=Apiserver -p 3306:3306 mysql:8.1.0
